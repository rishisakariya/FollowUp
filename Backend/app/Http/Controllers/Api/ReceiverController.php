...
class ReceiverController extends Controller
{
    ...
    public function updateReceiver(Request $request, $receiver_id)
    {
        ...
        // ❌ Old: if ($receiver->creator !== auth()->user()->user_id)
        if ($receiver->created_by !== auth()->user()->user_id) {
            return response()->json([
                'success' => false,
    ...
    public function getReceiversByUserId($user_id)
    {
        ...
        $receivers = Receiver::where('created_by', $user_id)->get();
    ...
    {
        $receivers = Receiver::with(['createdBy:user_id,name', 'updatedBy:user_id,name'])->get();
